...
@Configuration
@Slf4j
public class DelayedDirectRabbitConfig {
...
/**
    ...
    private static final String ORDER_DELAY_QUEUE = "delay.queue";
    */
/**
    ...
    public static final String ORDER_DELAY_EXCHANGE = "delay.exchange";
    */
/**
     * routing key 名称
    ...
    public static final String ORDER_DELAY_ROUTING_KEY = "orderDelay";
